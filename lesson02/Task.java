...
/**
 * Реализовать, с учетом ооп подхода,
 * приложение
 ...
 * c “проведением исследования” можно понимать получение
 * всех детей выбранного человека.
 * 
 * 
 * Используйя код написанный выше,
 * необходимо гарантированно продумать
 * иерархию компонент и взаимодействия их между собой.
 * 
 * Обеспечить переход от использования явных классов
 * в сторону использования абстрактных типов.
 * Т е работаем не с:
 * конкретным экземпляром генеалогического древа,
 * а с интерфейсом “генеалогическое древо”
 * конкретным экземпляром котика,
 * а с интерфейсом “котик”,
